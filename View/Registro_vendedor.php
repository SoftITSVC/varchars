...
<script type="text/javascript" src="../assets/js/validacionVendedores.js"></script>
</head>
<body>
	...
	<div class="login">
		...
		<div class="main-agileits">
				<div class="form-w3agile">
					...
					<form action="../Controller/registro_vendedoresControler.php" method="post"  enctype="multipart/form-data" onsubmit="return validar();">
					<div class="key">
						...
						<div class="key">
							<i class="fa fa-user" aria-hidden="true"></i>
							<input  type="text"  name="domicilio" id="domicilio" placeholder="Ingresa calle de donde vives">
							<div class="clearfix"></div>
						</div>
						<div class="key">
							<i class="fa fa-lock" aria-hidden="true"></i>
							<input  type="text"  name="curp" id="curp" placeholder="Ingresa tu CURP">
							<div class="clearfix"></div>
						</div>
						<div class="key">
							<i class="fa fa-lock" aria-hidden="true"></i>
						...
						<div class="key">
							<i class="fa fa-lock" aria-hidden="true"></i>
							<input  type="text" name="codigo_postal" id="codigo_postal" placeholder="Ingresa tu numero postal">
							<div class="clearfix"></div>
						</div> 
						...
						<div class="key">
							<i class="fa fa-lock" aria-hidden="true"></i>
							<input  type="text" name="correo_contacto" id="correo_contacto" placeholder="Ingresa tu correo de contacto">
							<div class="clearfix"></div>
						</div>
						<center><label>Ingresa una foto tuya:</label></center>
						<br>
						<input type="file" class="form-control-file border" name="foto_vendedor" id="foto_vendedor" accept=".jpg, .png">
						<br>
						<center><label>Ingresa una foto tu INE frontal:</label></center>
						<br>
						<input type="file" class="form-control-file border" name="foto_credencial_f" id="foto_credencial_f">
						<br>
						<center><label>Ingresa una foto tu INE trasera:</label></center>
						<br>
						<input type="file" class="form-control-file border"  name="foto_credencial_t" id="foto_credencial_t">
						<br>
						<center><button type="submit" onclick="validar();">Guardar</button></center>
					</form>
				</div>
			</div>
		</div>
